...
class Person
  ...
  references_and_referenced_in_many :tweets, :class_name => "Tweet", :stored_as => :array, :inverse_of => :people
...
class Tweet
  ...
  references_and_referenced_in_many :people, :class_name => "Person", :stored_as => :array, :inverse_of => :tweets
